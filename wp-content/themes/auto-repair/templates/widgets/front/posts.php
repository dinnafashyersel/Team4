					...
					<div class="clearfix">
						<div class="post_extra_info nothumb">
							<<?php echo $title_tag // xss ok ?> class="title">
								<a href="<?php echo esc_url( $c->comment_author_url ) ?>" rel="nofollow"><?php echo $c->comment_author // xss ok ?></a> <?php _e( 'on', 'auto-repair' ) ?> <a href="<?php echo esc_url( get_permalink( $post->ID ) ) ?>"><?php echo $post->post_title // xss ok ?></a>
