...
?><div class="post-content-outer single-post">
		...
		<div class="meta-top clearfix">
			...
			<?php if ( $meta_comments && comments_open() ): ?>
				<div class="comment-count">
					<a href="<?php comments_link() ?>" class="icon theme"><?php wpv_icon( 'comments' )?></a><?php comments_popup_link( __( '0 <span class="comment-word visuallyhidden">Comments</span>', 'auto-repair' ), __( '1 <span class="comment-word visuallyhidden">Comment</span>', 'auto-repair' ), __( '% <span class="comment-word visuallyhidden">Comments</span>', 'auto-repair' ) ); ?>
				</div>
			<?php endif; ?>
		</div>
	<?php endif ?>
	...
	<?php if ( $meta_tax ) : ?>
		<div class="meta-bottom clearfix">
			...
			<?php the_tags('<div class="the-tags"><span class="icon">' . wpv_get_icon('tag') . '</span><span class="visuallyhidden">' . __( 'Tags', 'auto-repair' ) . '</span>', ', ', '</div>' ) ?>
		</div>
	<?php endif ?>
