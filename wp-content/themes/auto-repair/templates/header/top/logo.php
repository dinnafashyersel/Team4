...
?>
<div class="logo-wrapper <?php if ( empty( $logo ) || $logo_type === 'site-title' ) echo 'with-text-logo' //xss ok ?>">
	...
	<div class="mobile-logo-additions">
		<?php if ( wpv_has_woocommerce() ): ?>
			...
			<a class="vamtam-cart-dropdown-link icon theme no-dropdown" href="<?php echo esc_attr( wc_get_cart_url() ) ?>">
