...
function wpv_revslider_importer_init() {
	...
	register_importer( 'wpv_revslider', 'Vamtam Slider Revolution Import', sprintf( __( 'Import Slider Revolution sliders from Vamtam themes, not to be used as a stand-alone product.', 'auto-repair' ), THEME_NAME ), array( $GLOBALS['wpv_revslider_import'], 'dispatch' ) );
}
