	...
	public function add_new_ui() {
		...
		<script type='text/html' id='wpv-add-sidebar-ui'>
			<form class='wpv-add-sidebar-ui' method='POST'>
				<h3><?php _e( 'Vamtam Widget Areas', 'auto-repair' ) ?></h3>
				<input type='text' value='' placeholder='<?php esc_attr_e( 'New Widget Area Name', 'auto-repair' ) ?>' name='new-sidebar-id' />
				<input type='submit' value='<?php esc_attr_e( 'Add Widget Area', 'auto-repair' ) ?>' class="button-primary" />
