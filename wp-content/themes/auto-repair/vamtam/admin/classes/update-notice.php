...
class WpvUpdateNotice {
	...
	public static function after_update_notice() {
		...
		_e( 'It is highly recommended that you regenerate your theme\'s CSS cache.', 'auto-repair' );
		echo '</strong></p><p>'; // xss ok
		printf( __( 'We advise you to head over to the <a href="%s">theme options</a> and click the "Save Changes" button. This will ensure that you are seeing the latest styles and that all theme caches have been cleared.', 'auto-repair' ), admin_url( 'admin.php?page=wpv_general' ) );
		echo '</p></div>'; // xss ok;
	}
