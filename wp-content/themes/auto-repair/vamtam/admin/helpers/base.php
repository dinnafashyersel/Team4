		...
		<div class="row-desc">
			...
			<div>
				<section class="content"><?php echo $desc // xss ok ?></section>
				    ...
				    <footer><a href="<?php echo esc_attr( 'http://support.vamtam.com' ) ?>" title="<?php esc_attr_e( 'Read more on our Help Desk', 'auto-repair' ) ?>" target="_blank"><?php _e( 'Read more on our Help Desk', 'auto-repair' ) ?></a>
				    </footer>
			</div>
		</div>
	<?php endif;
