...
return array(
array(
	'name' => __( 'Global Colors and Backgrounds', 'auto-repair' ),
	'type' => 'start',
),

array(
	'name' => __( 'Global Backgrounds', 'auto-repair' ),
	'type' => 'separator',
),
...
array(
	'desc'        => __( "You can also use some of the preset background patterns we've crafted for you", 'auto-repair' ),
	'type'        => 'autofill',
	'class'       => 'no-desc',
	'option_sets' => array(
		array(
			'name'   => __( 'Pattern 01', 'auto-repair' ),
		...
		array(
			'name'   => __( 'Pattern 02', 'auto-repair' ),
		...
		array(
			'name'   => __( 'Pattern 03', 'auto-repair' ),
		...
		array(
			'name'   => __( 'Pattern 04', 'auto-repair' ),
		...
		array(
			'name'   => __( 'Pattern 05', 'auto-repair' ),
		...
		array(
			'name'   => __( 'Pattern 06', 'auto-repair' ),
		...
		array(
			'name'   => __( 'Pattern 07', 'auto-repair' ),
		...
		array(
			'name'   => __( 'Pattern 08', 'auto-repair' ),
		...
		array(
			'name'   => __( 'Pattern 09', 'auto-repair' ),
		...
		array(
			'name'   => __( 'Pattern 10', 'auto-repair' ),
		...
		array(
			'name'   => __( 'Pattern 11', 'auto-repair' ),
		...
		array(
			'name'   => __( 'Pattern 12', 'auto-repair' ),
		...
		array(
			'name'   => __( 'Pattern 13', 'auto-repair' ),
		...
		array(
			'name'   => __( 'Pattern 14', 'auto-repair' ),
		...
		array(
			'name'   => __( 'Pattern 15', 'auto-repair' ),
...
array(
	'name' => __( 'Global Colors', 'auto-repair' ),
	'type' => 'separator',
),

array(
	'name' => __( 'Accent Colors', 'auto-repair' ),
	'desc' => __( 'Most of the design elements are attached to the accent colors below. You can easily create your own skin by changing these colors.', 'auto-repair' ),
	'type' => 'color-row',
	'inputs' => array(
		'accent-color-1' => array(
			'name' => __( 'Accent 1', 'auto-repair' ),
		),
		'accent-color-2' => array(
			'name' => __( 'Accent 2', 'auto-repair' ),
		),
		'accent-color-3' => array(
			'name' => __( 'Accent 3', 'auto-repair' ),
		),
		'accent-color-4' => array(
			'name' => __( 'Accent 4', 'auto-repair' ),
		),
		'accent-color-5' => array(
			'name' => __( 'Accent 5', 'auto-repair' ),
		),
		'accent-color-6' => array(
			'name' => __( 'Accent 6', 'auto-repair' ),
		),
		'accent-color-7' => array(
			'name' => __( 'Accent 7', 'auto-repair' ),
		),
		'accent-color-8' => array(
			'name' => __( 'Accent 8', 'auto-repair' ),
		),
	),
),
