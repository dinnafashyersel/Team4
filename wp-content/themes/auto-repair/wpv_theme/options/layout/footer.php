...
array(
	'name' => __( 'Footer Layout', 'auto-repair' ),
...
array(
	'name' => __( 'Enable Footer Widget Areas', 'auto-repair' ),
	'desc' => __( 'This option only enables the area. You can set the layout, using the two options below.  In appearance - widgets, you can populate the area with widgets.', 'auto-repair' ),
	'id' => 'has-footer-sidebars',
	'type' => 'toggle',
),

array(
	'name' => __( 'Footer Widget Area Pre-defined Layouts', 'auto-repair' ),
	'desc' => __( 'The widget areas bellow are placed between the body and the sub-footer.  You can either choose one of the predefined layouts or configure your own in the "Advanced" section bellow.', 'auto-repair' ),
	'type' => 'autofill',
	'class' => 'no-box',
	'option_sets' => array(
		array(
			'name' => __( '1/3 | 1/3 | 1/3', 'auto-repair' ),
		...
		array(
			'name' => __( '1/4 | 1/4 | 1/4 | 1/4', 'auto-repair' ),
		...
		array(
			'name' => __( '1/5 | 1/5 | 1/5 | 1/5 | 1/5', 'auto-repair' ),
...
array(
	'name' => __( 'Footer Widget Areas Advanced Layout Builder', 'auto-repair' ),
...
array(
	'name' => __( 'Text Area in Footer', 'auto-repair' ),
	'desc' => __( 'You can place text/HTML or any shortcode in this field. The text will appear in the  footer of your website.', 'auto-repair' ),
	'id' => 'credits',
	'type' => 'textarea',
	'static' => true,
),
